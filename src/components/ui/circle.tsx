...
export default function CircleLogo() {
  return (
    <div className="circle-perimeter">
      ...
      <div className="logo-center pulsating-circle flex items-center justify-center bg-pure rounded-full w-[60px] h-[60px] md:w-[80px] md:h-[80px] shadow-lg p-1 ">
      ...
      <div className="perimeter-logo logo-pos-2 bg-pure rounded-full w-[60px] h-[60px] md:w-[80px] md:h-[80px] shadow-lg p-1">
        <img
          className="dark:filter dark:brightness-0 dark:invert"
      ...
      <div className="perimeter-logo logo-pos-3 bg-pure rounded-full w-[60px] h-[60px] md:w-[80px] md:h-[80px] shadow-lg p-1">
        <img
          className="dark:filter dark:brightness-0 dark:invert"
