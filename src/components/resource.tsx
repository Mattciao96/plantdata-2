...
function Resource({ title, description, image, link, button }) {
  ...
  return (
    <div className="flex min-w-full justify-center">
      <div className="mb-20 flex w-[400px] min-w-full flex-col items-center justify-evenly gap-4 rounded-xl border border-input bg-pure p-6 first:mt-0 md:my-14 md:w-[900px] md:flex-row">
